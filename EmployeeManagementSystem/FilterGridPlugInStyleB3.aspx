<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FilterGridPlugInStyleB3.aspx.cs" Inherits="EmployeeManagementSystem.FilterGridPlugInStyleB3" %>
        ...
        <div class="row" style="margin-bottom: 10px;">
            ...
            <div class="col-sm-6 text-right">
                ...
                <input type="text" id="common-search" class="form-control input-sm"
                    style="width: 300px; max-width: 100%; display: inline-block; margin-left: 10px;"
